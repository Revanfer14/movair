...
extension Font {
    enum Brand {
        ...
        // Watch
        static let watchMetric          = Font.system(size: 40, weight: .semibold).monospacedDigit()
        static let watchMetricSmall     = Font.system(size: 28, weight: .semibold).monospacedDigit()
        static let watchCaption         = Font.system(size: 12, weight: .regular)
        static let watchCaptionBold     = Font.system(size: 12, weight: .semibold)
    }
}
